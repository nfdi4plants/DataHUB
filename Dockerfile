...
COPY templates/g-arc.tar.gz /opt/gitlab/embedded/service/gitlab-rails/vendor/project_templates/
COPY templates/m-arc.tar.gz /opt/gitlab/embedded/service/gitlab-rails/vendor/project_templates/
